    ...
    public function with(): array
    {
        return [
            'products' => Product::query()
                ->select('id', 'name', 'sku', 'barcode', 'price', 'cost_price', 'stock', 'unit', 'is_active', 'category_id', 'image_url')
        ...
        <div class="bg-white/70 backdrop-blur-md border border-stone-200 rounded-3xl p-4 mb-8 shadow-sm overflow-hidden">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div class="md:col-span-2 relative">
                    ...
                    <input wire:model.live.debounce.500ms="search" type="text" placeholder="Cari berdasarkan nama, SKU, atau barcode..." 
                           class="block w-full pl-11 pr-10 py-3 border-none bg-stone-100 rounded-2xl focus:ring-2 focus:ring-stone-900 focus:bg-white transition-all duration-200 text-stone-900 placeholder-stone-400 text-sm">
                    @if($search)
                    ...
                    <div wire:loading wire:target="search" class="absolute inset-y-0 right-0 pr-3 flex items-center">
                        <svg class="animate-spin h-4 w-4 text-stone-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>
                    </div>
                </div>
